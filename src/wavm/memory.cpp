...
{
    default_logger->debug("S - membarrier - {}", a);
    ...
    if (a == MEMBARRIER_CMD_QUERY) {
        ...
        default_logger->error("Unexpected membarrier argument {}",
                                          a);
...
{
    default_logger->debug("S - sbrk - {}", increment);
...
WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                               ...
                               I32 c)
{
    default_logger->debug("S - shm_open - {} {} {}", a, b, c);
