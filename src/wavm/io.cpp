...
WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                               ...
                               I32 resFdPtr)
{
    default_logger->debug("S - fd_dup - {}", fd, resFdPtr);
...
WAVM_DEFINE_INTRINSIC_FUNCTION(wasi,
                               ...
                               I32 resSizePtr)
{
    default_logger->trace("S - fd_readdir - {} {} {} {} {}",
                                      fd,
                                      buf,
                                      bufLen,
                                      startCookie,
...
{
    default_logger->debug("S - fd_close - {}", fd);
...
I32 s__access(I32 pathPtr, I32 mode)
{
    ...
    default_logger->debug("S - access - {} {}", path, mode);
...
{
    default_logger->debug("S - fstat64 - {} {}", fd, statBufPtr);
...
WAVM_DEFINE_INTRINSIC_FUNCTION(wasi,
                               ...
                               I32 resOffsetPtr)
{
    default_logger->trace("S - fd_tell - {} {}", fd, resOffsetPtr);
...
{
    default_logger->debug("S - ioctl - {} {} {}", a, b, c);
...
{
    default_logger->debug("S - puts - {}", strPtr);
    WAVMWasmModule* module = getExecutingWAVMModule();
...
{
    default_logger->debug("S - putc - {} {}", c, streamPtr);
...
{
    std::string pathStr = getStringFromWasm(pathPtr);
    default_logger->debug("S - path_readlink - {} {} {} {} {}",
                                      rootFd,
                                      pathStr,
                                      buffPtr,
                                      buffLen,
...
{
    default_logger->debug("S - lockf - {} {} {}", a, b, c);
    throwException(Runtime::ExceptionTypes::calledUnimplementedIntrinsic);
}
...
WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                               ...
                               I32 c)
{
    default_logger->debug("S - strncat - {} {} {}", a, b, c);
    throwException(Runtime::ExceptionTypes::calledUnimplementedIntrinsic);
}

WAVM_DEFINE_INTRINSIC_FUNCTION(env, "realpath", I32, realpath, I32 a, U32 b)
{
    default_logger->debug("S - realpath - {} {}", a, b);
    throwException(Runtime::ExceptionTypes::calledUnimplementedIntrinsic);
}
