                               ...
                               I32 flags)
{
    ...
    if (fileNamePtr == 0) {
        realPath = "";
        default_logger->debug("S - dlopen - nullptr {}", flags);
    } else {
                               ...
                               I32 symbolPtr)
{
    ...
    default_logger->debug("S - dlsym - {} {}", handle, symbol);
...
{
    default_logger->debug("S - dlerror");
...
{
    default_logger->debug("S - _dlclose {}", handle);
