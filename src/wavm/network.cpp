...
I32 s__socketcall(I32 call, I32 argsPtr)
{
    ...
    switch (call) {
        ...
        case (SocketCalls::sc_connect): {
            ...
            default_logger->debug(
              "S - connect - {} {} {}", sockfd, addrPtr, addrLen);
                               ...
                               I32 hostnamePtr)
{
    ...
    default_logger->debug("S - gethostbyname {}", hostname);
...
{
    default_logger->debug(
      "S - gethostname {} {}", buffer, bufferLen);
