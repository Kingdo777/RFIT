 ...
 */
    ...
    Stat FileDescriptor::stat(const std::string &relativePath) {
        ...
        statResult.st_atim = RFIT_NS::utils::timespecToNanos(&nativeStat.st_atim);
        statResult.st_mtim = RFIT_NS::utils::timespecToNanos(&nativeStat.st_mtim);
        statResult.st_ctim = RFIT_NS::utils::timespecToNanos(&nativeStat.st_ctim);
